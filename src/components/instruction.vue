          ...
          <v-layout row wrap>
            <v-flex>
              <v-card class="px-2">
                ...
                <v-divider></v-divider>
                <v-card-text>
                  请在答题页面的输入框内输入电影的中文名，仅输入正题，切勿输入代数以及副标题。比如《王的男人2：秘密服务》只需要填写王的男人。<br>点击偷看按钮可偷看部分答案，但是最终得分会减半。<br>再想不出点击投降查看完整答案。
                </v-card-text>
              </v-card>
            </v-flex>
            <v-flex>
              <v-card class="px-2">
                ...
                <v-divider></v-divider>
                <v-card-text>
                  本网页中的大部分图片来自网络搜索。少部分来自B站影视区UP主电影最TOP的淘宝店（有水印）。极少部分GV画质的原图被我手动照着重画了。<br>图片只作交流学习，不涉及商用。若有侵权请联系删除。
                </v-card-text>
              </v-card>
            </v-flex>
            <v-flex>
